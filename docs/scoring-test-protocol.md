...
| Correlation discount (person/pov_count only) | No effect (not redundant with anything in this case) | Real fix -- pov_count drops from dominant to below-trope-scale | **Landed** |
